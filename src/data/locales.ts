...
export const localizedHome: Record<LocaleKey, LocalizedHomeCopy> = {
  de: {
    ...
    hreflang: 'de-DE',
    ogLocale: 'de_DE',
    title: 'Wojciech Luszczynski · AI-native GTM Operator',
    ...
    lensSection: {
      ...
      titlePrimary: 'Drei Perspektiven.',
      titleSecondary: 'Ein Operating Model.',
      aiNote: 'AI läuft durch alle drei: Automatisierung, Agenten und AI-Workflows in jeder Perspektive verdrahtet.',
      aiLink: 'Wie ich mit AI baue →',
      lenses: [
        { name: 'GTM', thesis: 'Pipeline, die sich aufbaut. CRM, outbound und paid in einem System verbunden, nicht in vier Dashboards.', exploreLabel: 'Zu /gtm →' },
        { name: 'Marketing', thesis: 'Nachfrage statt Impressionen. Positionierung, Content und Marke so gebaut, dass sie Pipeline erzeugen.', exploreLabel: 'Zu /marketing →' },
        { name: 'Growth', thesis: 'Experimente, die live gehen. Aktivierung, Retention und Lifecycle-Schleifen, gemessen in Revenue.', exploreLabel: 'Zu /growth →' },
      ],
    },
  ...
  dk: {
    ...
    lensSection: {
      eyebrow: 'Sådan hjælper jeg',
      titlePrimary: 'Tre perspektiver.',
      titleSecondary: 'Én operating model.',
      aiNote: 'AI løber gennem alle tre: automatisering, agenter og AI-workflows koblet ind i hvert perspektiv.',
      aiLink: 'Hvordan jeg bygger med AI →',
      lenses: [
        { name: 'GTM', thesis: 'Pipeline, der bygger sig op. CRM, outbound og paid koblet i ét system, ikke fire dashboards.', exploreLabel: 'Se /gtm →' },
        { name: 'Marketing', thesis: 'Efterspørgsel, ikke visninger. Positionering, indhold og brand bygget til at skabe pipeline.', exploreLabel: 'Se /marketing →' },
        { name: 'Growth', thesis: 'Eksperimenter, der går live. Aktivering, retention og lifecycle-loops målt i revenue.', exploreLabel: 'Se /growth →' },
      ],
    },
  ...
  no: {
    ...
    lensSection: {
      eyebrow: 'Slik hjelper jeg',
      titlePrimary: 'Tre perspektiver.',
      titleSecondary: 'Én operating model.',
      aiNote: 'AI går gjennom alle tre: automatisering, agenter og AI-arbeidsflyter koblet inn i hvert perspektiv.',
      aiLink: 'Hvordan jeg bygger med AI →',
      lenses: [
        { name: 'GTM', thesis: 'Pipeline som bygger seg opp. CRM, outbound og paid koblet i ett system, ikke fire dashboards.', exploreLabel: 'Se /gtm →' },
        { name: 'Marketing', thesis: 'Etterspørsel, ikke visninger. Posisjonering, innhold og merkevare bygget for å skape pipeline.', exploreLabel: 'Se /marketing →' },
        { name: 'Growth', thesis: 'Eksperimenter som går live. Aktivering, retention og lifecycle-looper målt i revenue.', exploreLabel: 'Se /growth →' },
      ],
    },
  ...
  jp: {
    ...
    lensSection: {
      eyebrow: '私にできること',
      titlePrimary: '3つの視点。',
      titleSecondary: 'ひとつのオペレーティングモデル。',
      aiNote: 'AIは3つすべてを貫きます。自動化、エージェント、AIワークフローをそれぞれの視点に組み込みます。',
      aiLink: 'AIでの構築方法 →',
      lenses: [
        { name: 'GTM', thesis: '積み上がるpipeline。CRM、outbound、広告を4つのダッシュボードではなく、ひとつのシステムにつなぎます。', exploreLabel: '/gtm を見る →' },
        { name: 'Marketing', thesis: 'インプレッションではなく需要を。ポジショニング、コンテンツ、ブランドをpipelineが生まれる形に設計します。', exploreLabel: '/marketing を見る →' },
        { name: 'Growth', thesis: '実装まで届く実験。アクティベーション、リテンション、ライフサイクルをrevenueで測ります。', exploreLabel: '/growth を見る →' },
      ],
    },
    sectionEyebrow: '私の仕事',
  ...
  it: {
    ...
    lensSection: {
      ...
      titlePrimary: 'Tre prospettive.',
      titleSecondary: 'Un solo sistema operativo.',
      aiNote: 'L\'AI attraversa tutte e tre: automazioni, agenti e workflow AI collegati a ogni prospettiva.',
      aiLink: 'Come costruisco con l\'AI →',
      lenses: [
        { name: 'GTM', thesis: 'Pipeline che si accumula. CRM, outbound e paid collegati in un solo sistema, non in quattro dashboard.', exploreLabel: 'Vai a /gtm →' },
        { name: 'Marketing', thesis: 'Domanda, non impression. Posizionamento, contenuti e brand progettati per generare pipeline.', exploreLabel: 'Vai a /marketing →' },
        { name: 'Growth', thesis: 'Esperimenti che arrivano in produzione. Attivazione, retention e cicli di vita misurati in revenue.', exploreLabel: 'Vai a /growth →' },
      ],
    },
  ...
  es: {
    ...
    lensSection: {
      eyebrow: 'En qué ayudo',
      titlePrimary: 'Tres perspectivas.',
      titleSecondary: 'Un solo sistema operativo.',
      aiNote: 'La AI atraviesa las tres: automatizaciones, agentes y workflows de AI conectados a cada perspectiva.',
      aiLink: 'Cómo construyo con AI →',
      lenses: [
        { name: 'GTM', thesis: 'Pipeline que se acumula. CRM, outbound y paid conectados en un solo sistema, no en cuatro dashboards.', exploreLabel: 'Ver /gtm →' },
        { name: 'Marketing', thesis: 'Demanda, no impresiones. Posicionamiento, contenido y marca diseñados para generar pipeline.', exploreLabel: 'Ver /marketing →' },
        { name: 'Growth', thesis: 'Experimentos que llegan a producción. Activación, retención y ciclos de vida medidos en revenue.', exploreLabel: 'Ver /growth →' },
      ],
    },
