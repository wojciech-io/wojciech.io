...
export const localizedHome: Record<LocaleKey, LocalizedHomeCopy> = {
  ...
  it: {
    ...
    ogLocale: 'it_IT',
    title: 'Wojciech Łuszczyński · AI-native GTM Operator',
    description: 'Sistemi di ricavo AI-native per SaaS B2B. Architetto GTM che integra CRM, outbound, acquisizione a pagamento e flussi di lavoro AI in un unico modello operativo.',
  ...
  es: {
    ...
    ogLocale: 'es_ES',
    title: 'Wojciech Łuszczyński · AI-native GTM Operator',
    description: 'Sistemas de ingresos AI-native para SaaS B2B. Arquitecto GTM que integra CRM, outbound, adquisición de pago y flujos de trabajo de IA en un único modelo operativo.',
