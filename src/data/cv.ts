...
export const cvData: CvData = {
  meta: {
    title: {
      en: 'Wojciech Luszczynski · CV',
      pl: 'Wojciech Łuszczyński · CV',
      de: 'Wojciech Luszczynski · Lebenslauf',
      dk: 'Wojciech Luszczynski · CV',
      no: 'Wojciech Luszczynski · CV',
      jp: 'Wojciech Luszczynski · 職務経歴書',
      it: 'Wojciech Luszczynski · CV',
      es: 'Wojciech Luszczynski · CV',
    },
    description: {
      en: 'CV of Wojciech Luszczynski, GTM Architect and Growth Operator. AI-native revenue systems for B2B SaaS. 20 years marketing, 10 years B2B SaaS growth.',
      ...
      de: 'Lebenslauf von Wojciech Luszczynski, GTM Architect und Growth Operator. AI-native Revenue-Systeme für B2B SaaS. 20 Jahre Marketing, 10 Jahre B2B SaaS Growth.',
      dk: 'CV for Wojciech Luszczynski, GTM Architect og Growth Operator. AI-native revenue-systemer til B2B SaaS. 20 år med marketing, 10 år med B2B SaaS growth.',
      no: 'CV for Wojciech Luszczynski, GTM Architect og Growth Operator. AI-native revenue-systemer for B2B SaaS. 20 år med markedsføring, 10 år med B2B SaaS growth.',
      jp: 'Wojciech Luszczynskiの職務経歴書。GTM Architect、Growth Operator。B2B SaaS向けのAI-native revenue systems。マーケティング20年、B2B SaaS growth 10年。',
      it: 'CV di Wojciech Luszczynski, GTM Architect e Growth Operator. Sistemi di ricavo AI-native per B2B SaaS. 20 anni di marketing, 10 anni di growth in B2B SaaS.',
      es: 'CV de Wojciech Luszczynski, GTM Architect y Growth Operator. Sistemas de revenue AI-native para B2B SaaS. 20 años en marketing, 10 años en growth B2B SaaS.',
    },
  },
  header: {
    tagline: {
  ...
  experience: [
    {
      ...
      bullets: {
        en: [
          'Structured enterprise GTM across content, SEO, paid tests, lifecycle flows and sales follow up',
          'Deployed a lead scoring model and funnel dashboard for account priority and handoff quality',
          'Shipped technical buyer assets, landing pages and conversion paths for cloud and security offers',
          'Turned campaign data into weekly pipeline reviews, learning loops and revenue decisions',
        ],
        pl: [
          'Uporządkowałem GTM w enterprise: content, SEO, testy paid, przepływy lifecycle i followup sprzedaży',
          'Wdrożyłem model scoringu leadów i dashboard lejka pod priorytet kont i jakość przekazania',
          'Dowiozłem materiały dla kupca technicznego, landingi i ścieżki konwersji dla ofert cloud i security',
          'Zamieniłem dane z kampanii na cotygodniowe przeglądy pipeline’u, pętle wniosków i decyzje o przychodzie',
        ],
        de: [
          'Strukturierte Enterprise-GTM über Content, SEO, Paid-Tests, Lifecycle-Flows und Sales-Follow-up',
          'Führte ein Lead-Scoring-Modell und ein Funnel-Dashboard für Account-Priorität und Übergabequalität ein',
          'Lieferte Assets für technische Käufer, Landingpages und Conversion-Pfade für Cloud- und Security-Angebote',
          'Machte aus Kampagnendaten wöchentliche Pipeline-Reviews, Learning-Loops und Umsatzentscheidungen',
        ],
        dk: [
          'Strukturerede enterprise-GTM på tværs af content, SEO, paid-tests, lifecycle-flows og salgsopfølgning',
          'Indførte en lead scoring-model og et funnel-dashboard til kontoprioritet og overleveringskvalitet',
          'Leverede materialer til tekniske købere, landingssider og konverteringsveje til cloud- og security-tilbud',
          'Omsatte kampagnedata til ugentlige pipeline-reviews, læringssløjfer og omsætningsbeslutninger',
        ],
        no: [
          'Strukturerte enterprise-GTM på tvers av content, SEO, paid-tester, lifecycle-flyt og salgsoppfølging',
          'Innførte en lead scoring-modell og et funneldashbord for kontoprioritet og overleveringskvalitet',
          'Leverte materiell for tekniske kjøpere, landingssider og konverteringsveier for cloud- og security-tilbud',
          'Gjorde kampanjedata om til ukentlige pipeline-gjennomganger, læringssløyfer og inntektsbeslutninger',
        ],
        jp: [
          'コンテンツ、SEO、ペイド検証、ライフサイクル、営業フォローアップにわたりエンタープライズGTMを体系化',
          'アカウント優先度と引き継ぎ品質のためにリードスコアリングとファネルダッシュボードを導入',
          'クラウドとセキュリティ提案向けに技術購買者向け資料、ランディングページ、コンバージョン導線を実装',
          'キャンペーンデータを週次のパイプラインレビュー、学習サイクル、売上判断に変換',
        ],
        it: [
          'Ho strutturato il GTM enterprise su content, SEO, test paid, flussi lifecycle e follow up commerciale',
          'Ho introdotto un modello di lead scoring e una dashboard di funnel per priorità account e qualità del passaggio',
          'Ho rilasciato materiali per buyer tecnici, landing page e percorsi di conversione per offerte cloud e security',
          'Ho trasformato i dati di campagna in review settimanali di pipeline, cicli di apprendimento e decisioni sui ricavi',
        ],
        es: [
          'Estructuré el GTM enterprise en contenido, SEO, tests de paid, flujos de lifecycle y seguimiento comercial',
          'Implanté un modelo de scoring de leads y un dashboard de funnel para prioridad de cuentas y calidad del traspaso',
          'Entregué materiales para el comprador técnico, landings y rutas de conversión para ofertas de cloud y seguridad',
          'Convertí los datos de campaña en revisiones semanales de pipeline, ciclos de aprendizaje y decisiones de ingresos',
        ],
      },
    },
    {
      ...
      bullets: {
        en: [
          'Reframed AI GTM positioning for website builder adoption, trial starts and partner demand',
          'Ran acquisition sprints across paid, SEO, activation email and product-led onboarding',
          'Built growth reporting across visitor quality, trial starts, paid plans and campaign ROI',
          'Aligned website funnels, CRM follow up and onboarding messages for SaaS conversion flow',
        ],
        pl: [
          'Przeformułowałem pozycjonowanie AI GTM pod adopcję kreatora stron, starty trialu i popyt partnerski',
          'Prowadziłem sprinty akwizycyjne: paid, SEO, maile aktywacyjne i onboarding product-led',
          'Zbudowałem raportowanie wzrostu: jakość ruchu, starty trialu, plany płatne i ROI kampanii',
          'Spiąłem lejki na stronie, followup w CRM i komunikaty onboardingowe pod konwersję SaaS',
        ],
        de: [
          'Schärfte die AI-GTM-Positionierung für Adoption des Website-Builders, Trial-Starts und Partner-Demand',
          'Fuhr Akquise-Sprints über Paid, SEO, Aktivierungs-E-Mails und Product-led Onboarding',
          'Baute Growth-Reporting über Besucherqualität, Trial-Starts, bezahlte Pläne und Kampagnen-ROI auf',
          'Brachte Website-Funnels, CRM-Follow-up und Onboarding-Nachrichten für den SaaS-Conversion-Flow zusammen',
        ],
        dk: [
          'Omformulerede AI-GTM-positioneringen for adoption af website-builderen, trial-starter og partner-demand',
          'Kørte akkvisitionssprints på tværs af paid, SEO, aktiveringsmails og product-led onboarding',
          'Byggede vækstrapportering på besøgskvalitet, trial-starter, betalte planer og kampagne-ROI',
          'Samlede website-funnels, CRM-opfølgning og onboarding-beskeder til SaaS-konverteringsflowet',
        ],
        no: [
          'Omformulerte AI-GTM-posisjoneringen for adopsjon av nettstedsbyggeren, trial-starter og partnerdemand',
          'Kjørte akkvisisjonssprinter på tvers av paid, SEO, aktiveringse-poster og product-led onboarding',
          'Bygde vekstrapportering på besøkskvalitet, trial-starter, betalte planer og kampanje-ROI',
          'Samlet nettstedsfunneler, CRM-oppfølging og onboardingmeldinger for SaaS-konverteringsflyten',
        ],
        jp: [
          'ウェブサイトビルダーの導入、トライアル開始、パートナー需要に向けAI GTMのポジショニングを再定義',
          'ペイド、SEO、アクティベーションメール、プロダクト主導のオンボーディングで獲得スプリントを実施',
          '訪問者の質、トライアル開始、有料プラン、キャンペーンROIにわたる成長レポートを構築',
          'サイトのファネル、CRMフォローアップ、オンボーディング文面をSaaSの転換フローに合わせて統一',
        ],
        it: [
          'Ho riformulato il posizionamento AI GTM per adozione del website builder, avvio dei trial e domanda partner',
          'Ho condotto sprint di acquisizione su paid, SEO, email di attivazione e onboarding product-led',
          'Ho costruito il reporting di crescita su qualità dei visitatori, avvio trial, piani a pagamento e ROI di campagna',
          'Ho allineato funnel del sito, follow up CRM e messaggi di onboarding al flusso di conversione SaaS',
        ],
        es: [
          'Reformulé el posicionamiento AI GTM para la adopción del creador de webs, el inicio de pruebas y la demanda de partners',
          'Dirigí sprints de adquisición en paid, SEO, correos de activación y onboarding product-led',
          'Construí el reporting de crecimiento sobre calidad de visitas, inicios de prueba, planes de pago y ROI de campaña',
          'Alineé los funnels del sitio, el seguimiento en CRM y los mensajes de onboarding con el flujo de conversión SaaS',
        ],
      },
    },
    {
    ...
    },
    {
      ...
      bullets: {
        en: [
          'Improved conversion +25% while growing top SERP positions across Nordic stores',
          'Owned Nordic growth for IVISKIN and Neatsvor across SEO, PPC, CRO and merchandising',
        ...
        pl: [
          ...
          'Odpowiadałem za wzrost IVISKIN i Neatsvor w Nordics: SEO, PPC, CRO i merchandising',
        ...
        de: [
          ...
          'Verantwortete das nordische Wachstum von IVISKIN und Neatsvor über SEO, PPC, CRO und Merchandising',
        ...
        dk: [
          ...
          'Ejede nordisk vækst for IVISKIN og Neatsvor på tværs af SEO, PPC, CRO og merchandising',
        ...
        no: [
          ...
          'Eide nordisk vekst for IVISKIN og Neatsvor på tvers av SEO, PPC, CRO og merchandising',
        ...
        jp: [
          ...
          'IVISKINとNeatsvorの北欧での成長を、SEO、PPC、CRO、マーチャンダイジングにわたり統括',
        ...
        it: [
          ...
          'Ho gestito la crescita nordica di IVISKIN e Neatsvor su SEO, PPC, CRO e merchandising',
        ...
        es: [
          ...
          'Asumí el crecimiento nórdico de IVISKIN y Neatsvor en SEO, PPC, CRO y merchandising',
    ...
    {
      period: 'Earlier',
      role: { en: 'Retail Marketing Specialist', pl: 'Retail Marketing Specialist', de: 'Retail Marketing Specialist', dk: 'Retail Marketing Specialist', no: 'Retail Marketing Specialist', jp: 'Retail Marketing Specialist', it: 'Retail Marketing Specialist', es: 'Retail Marketing Specialist' },
      company: 'mBank',
      bullets: {
        en: [
          'Coordinated retail banking launches, branch campaigns and product communication',
          'Supported acquisition materials, sales enablement and customer offer rollouts',
        ],
        pl: [
          'Koordynowałem premiery w bankowości detalicznej, kampanie oddziałowe i komunikację produktów',
          'Wspierałem materiały akwizycyjne, sales enablement i wdrożenia ofert dla klientów',
        ],
        de: [
          'Koordinierte Launches im Retail Banking, Filialkampagnen und Produktkommunikation',
          'Unterstützte Akquise-Materialien, Sales Enablement und den Rollout von Kundenangeboten',
        ],
        dk: [
          'Koordinerede lanceringer i retail banking, filialkampagner og produktkommunikation',
          'Understøttede akkvisitionsmateriale, sales enablement og udrulning af kundetilbud',
        ],
        no: [
          'Koordinerte lanseringer i retail banking, filialkampanjer og produktkommunikasjon',
          'Støttet akkvisisjonsmateriell, sales enablement og utrulling av kundetilbud',
        ],
        jp: [
          'リテールバンキングの立ち上げ、支店キャンペーン、商品コミュニケーションを調整',
          '獲得用資料、セールスイネーブルメント、顧客向けオファーの展開を支援',
        ],
        it: [
          'Ho coordinato lanci nel retail banking, campagne di filiale e comunicazione di prodotto',
          'Ho supportato materiali di acquisizione, sales enablement e rollout delle offerte ai clienti',
        ],
        es: [
          'Coordiné lanzamientos de banca minorista, campañas de oficina y comunicación de producto',
          'Apoyé materiales de captación, sales enablement y despliegues de ofertas a clientes',
        ],
      },
    },
    {
      period: 'Earlier',
      role: { en: 'IT Lecturer', pl: 'IT Lecturer', de: 'IT Lecturer', dk: 'IT Lecturer', no: 'IT Lecturer', jp: 'IT Lecturer', it: 'IT Lecturer', es: 'IT Lecturer' },
      company: 'LCDNiKP',
      bullets: {
        en: [
          'Taught practical IT, CMS and web design for adult learners and public courses',
          'Prepared learning materials for office tools, internet services and publishing',
        ],
        pl: [
          'Uczyłem praktycznego IT, CMS i projektowania stron dorosłych słuchaczy i na kursach publicznych',
          'Przygotowywałem materiały dydaktyczne z narzędzi biurowych, usług internetowych i publikowania',
        ],
        de: [
          'Unterrichtete praktische IT, CMS und Webdesign für Erwachsene und öffentliche Kurse',
          'Erstellte Lernmaterialien zu Büro-Tools, Internetdiensten und Publishing',
        ],
        dk: [
          'Underviste i praktisk it, CMS og webdesign for voksne og på offentlige kurser',
          'Udarbejdede undervisningsmateriale om kontorværktøjer, internettjenester og publicering',
        ],
        no: [
          'Underviste i praktisk IT, CMS og webdesign for voksne og på offentlige kurs',
          'Utarbeidet læremateriell om kontorverktøy, internettjenester og publisering',
        ],
        jp: [
          '成人学習者と公開講座向けに実務的なIT、CMS、ウェブデザインを指導',
          'オフィスツール、インターネットサービス、パブリッシングの教材を作成',
        ],
        it: [
          'Ho insegnato informatica pratica, CMS e web design ad adulti e in corsi pubblici',
          'Ho preparato materiali didattici su strumenti da ufficio, servizi internet e publishing',
        ],
        es: [
          'Impartí informática práctica, CMS y diseño web para adultos y en cursos públicos',
          'Preparé materiales de aprendizaje sobre herramientas de oficina, servicios de internet y publicación',
        ],
      },
    },
  ],
