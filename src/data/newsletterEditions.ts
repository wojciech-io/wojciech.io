/**
 * AI Espresso — recent issues, mirrored from apps/subscribe/src/data/editions.ts
 * (that copy stays the source of truth for the automation that authors it).
 * Update both when a new issue ships until this is consolidated into a
 * shared package.
 */
