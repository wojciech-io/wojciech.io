...
<Diagram caption="A request that matches no bet is not written. It is recorded as a refusal, with the price of changing the plan spelled out next to it.">
  <Box variant="muted" label="incoming request" sub="serves no bet" />
  <Arrow direction="right" dashed label="no match" />
  <Stack direction="row" gap="sm">
    <Box variant="outline" label="B1" />
    <Box variant="outline" label="B2" />
    <Box variant="outline" label="B3" />
  </Stack>
</Diagram>
