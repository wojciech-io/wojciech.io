...
Just [Claude Code](https://docs.anthropic.com/en/docs/claude-code/overview), a handful of MCP tools, a well-structured CLAUDE.md, and five operator skills wired together. I published a starter template for this in [the CLAUDE.md bite](/bites/).
...
If you're building something similar, grab the [CLAUDE.md starter template](/bites/) or [reach out](/contact/) to walk through the architecture. I also wrote about [how this runs inside real client work](/insights/claude-code-client-gtm/) and [the full AI stack in production](/insights/ai-production-stack/).
