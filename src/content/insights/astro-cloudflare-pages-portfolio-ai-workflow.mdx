---
title: "Rebuilding my site with Claude Code, Codex, and zero frontend experience"
description: "The full story of migrating from Framer to Astro + Cloudflare Pages using AI agents. What I directed, what they built, and where the human loop actually mattered."
...
The public site is [wojciech.io](https://wojciech.io/). The app-style portfolio surface is app.wojciech.io. The point of the rebuild was to make both feel like parts of one operating system: public positioning, shipped proof, apps, CV, writing, contact, and future case studies.
...
<TwoUp
  left={{ title: 'Before (Framer era)', items: ['Visual builder, fast iteration', 'No versioning, no Git history', 'Limited MDX, no content collections', 'Single surface, hard to extend'] }}
  right={{ title: 'After (Astro + CF)', items: ['Code-first, agent-editable', 'Full Git history, branch previews', 'MDX articles, 44 custom components', 'Seven surfaces, one operating system'] }}
/>
...
<Callout type="tip" title="The consolidation argument">
When DNS, CDN, WAF, hosting, and deploy verification are on the same platform, the operational surface is one dashboard and one API. I wrote about the full [security and identity stack that comes with Cloudflare](/insights/cloudflare-migration-zero-trust-free-tier/) separately.
</Callout>
...
<Tabs labels={['Claude Code', 'Codex', 'Human review']}>
  <Fragment slot="0">Larger implementation batches: foundations, page structures, components, content migration, article templates, broad page implementation. Worked best when the task had clear docs and bounded scope.</Fragment>
  <Fragment slot="1">Engineering iteration: reading the current repo state, making focused patches, resolving conflicts, running builds, checking UI with browser automation, verifying production after deployment, tightening details after screenshot review.</Fragment>
  <Fragment slot="2">Deciding whether the UI felt right, whether the copy sounded like me, whether a section was too large or too generic, and whether the system was ready to publish. The agents produced and adjusted. I directed and accepted.</Fragment>
</Tabs>
...
<Callout type="warning" title="CF dashboard trap">
Cloudflare's "Block AI bots" is on by default for many accounts. It silently injects Disallow rules that kill AI indexing. Switch to "Content Signals Policy" and control access via your own robots.txt instead.
</Callout>
...
<Steps items={[
  { title: "Sprint 0: Audit and direction", body: "Old-site inventory, migration decisions, what to retire, what the new site needed to prove." },
  { title: "Sprint 1: Foundation", body: "Astro, Tailwind, tokens, layouts, metadata, content collections, reusable components." },
  { title: "Sprint 2: Core pages and proof", body: "Homepage, work, AI systems, about, proof cards, testimonials, app links. Skeleton to narrative." },
  { title: "Sprint 3: Content and launch", body: "Article system, redirects, RSS, sitemap, robots, structured metadata, launch checks." },
  { title: "Sprint 4: Post-launch hardening", body: "App surface, CV, stack, timeline, contact, toggles, footer, light/dark mode, visual consistency." },
]} />
...
- app.wojciech.io is aligned more closely with the public site;
