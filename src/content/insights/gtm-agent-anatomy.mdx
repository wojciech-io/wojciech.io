---
title: "GTM agent anatomy: how the four-layer stack actually works"
description: "A detailed breakdown of the architecture behind the Claude Code GTM Agent — operator identity, MCP tools, client memory, and reusable skills."
