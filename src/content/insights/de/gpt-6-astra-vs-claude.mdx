...
description: "OpenAI hat GPT-6 Astra für 10 Dollar pro Million Input-Token veröffentlicht. Im Artificial Analysis Intelligence Index liegt das Modell auf Platz vier, hinter drei Claude-Modellen, und gewinnt fast jeden Benchmark, bei dem Arbeit fertig werden muss. Was diese Spaltung bedeutet, wenn Sie auf diesen Modellen bauen."
