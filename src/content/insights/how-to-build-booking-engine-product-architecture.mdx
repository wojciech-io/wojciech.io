...
<Tabs labels={['Backend', 'Payments', 'Notifications', 'Admin']}>
  ...
  <Fragment slot="1">Stripe, not Przelewy24 or PayU. The developer experience is better and international card coverage matters for tourist traffic. Polish card acceptance is complete through Stripe.</Fragment>
  <Fragment slot="2">SMS via Twilio. In testing, email confirmation had a 34% open rate within 10 minutes. SMS had a 94% open rate within 2 minutes. For a booking confirmation with gate code and pitch number, that difference matters operationally.</Fragment>
