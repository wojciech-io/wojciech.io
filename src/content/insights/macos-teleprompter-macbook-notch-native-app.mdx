...
<DataTable
  columns={[
    { key: "choice", label: "Choice", mono: true },
    { key: "effect", label: "What it buys" },
  ]}
  rows={[
    { choice: "NSPanel + .nonactivatingPanel", effect: "Never steals focus from the meeting window" },
    { choice: "NSWindow.Level.floating", effect: "Always on top, below system alerts" },
    { choice: "Manual step mode", effect: "Arrow keys cycle through bullet points" },
    { choice: "Notch-aware positioning", effect: "Correct Y offset per MacBook model" },
  ]}
/>
...
<Callout type="tip" title="The pattern is reproducible">
