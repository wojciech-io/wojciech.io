...
description: "Anthropic's new Claude Fable 5 costs twice as much as Opus 4.8. Instead of repeating launch benchmarks I let Fable 5, Opus and Sonnet each audit my own site's repo. Fable found a bug that would have broken my site during a real outage, Opus was cheaper per result, Sonnet missed it entirely. Full scores, costs and the fix, all public."
