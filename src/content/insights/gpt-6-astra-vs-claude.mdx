...
For the head-to-head pairs, see [Astra against Opus 5](/insights/gpt-6-astra-vs-claude-opus-5/) and [Astra against Fable 5.1](/insights/gpt-6-astra-vs-claude-fable-5-1/). For the harness view of the same fight, see [Claude Code against Codex](/insights/claude-code-vs-codex/), and for what changed between index versions, [the v4.3 explainer](/insights/artificial-analysis-intelligence-index-v4-3/). Every current model in one table is in [the AI model comparison](/insights/ai-model-comparison/).
