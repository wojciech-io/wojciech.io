...
For the harness view of the same fight, see [Claude Code against Codex](/insights/claude-code-vs-codex/). For what changed between index versions, see [the v4.3 explainer](/insights/artificial-analysis-intelligence-index-v4-3/).
