...
For the tier below, see [Haiku 4.5 against Luna](/insights/claude-haiku-4-5-vs-gpt-5-6-luna/). For the step up, [Sonnet 5 against Opus 5](/insights/claude-sonnet-5-vs-opus-5/). If you are still on Sonnet 4.6, [Luna against Sonnet 4.6](/insights/gpt-5-6-luna-vs-claude-sonnet-4-6/). Every current model in one table is in [the AI model comparison](/insights/ai-model-comparison/).
