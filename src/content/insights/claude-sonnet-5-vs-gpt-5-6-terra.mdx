...
description: "Terra and Sonnet 5 both cost $2 per million input tokens, and Sonnet 5 is cheaper on output. Terra scores two points higher. Here is how I decide between them, and why the token price is the wrong place to look."
