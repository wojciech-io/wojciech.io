...
Just Claude Code, a handful of [MCP](https://modelcontextprotocol.io) tools, a well-structured CLAUDE.md (grab the [starter template](/resources/)), and five operator skills wired together.
