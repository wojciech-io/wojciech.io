---
title: "A GTM agent that runs outbound, enriches CRM, and costs $2 per run"
description: "No Clay, no Apollo credits, no n8n. A four-layer Claude Code agent that handles outbound research, sequence drafts, and CRM enrichment natively."
...
This is a breakdown of a working system I built and run: a four-layer [Claude Code](https://docs.anthropic.com/en/docs/claude-code) agent stack that handles outbound research, sequence drafting, CRM enrichment, and ICP scoring. No [Clay](https://clay.com). No [Apollo](https://apollo.io) enrichment credits. No [n8n](https://n8n.io) flows that break every three weeks.

Just Claude Code, a handful of [MCP](https://modelcontextprotocol.io) tools, a well-structured CLAUDE.md (grab the [starter template](/bites/)), and five operator skills wired together.
...
- You're buying enrichment credits, not intelligence. Clay routes data through third-party providers: [Clearbit](https://clearbit.com/), [Apollo](https://www.apollo.io/), LinkedIn scrapers: and bills per row. The LLM reasoning layer is thin.
...
research/        # per-account research notes`}
  caption="The agent reads these at session start. Every sequence is grounded in actual research."
/>
...
If you cannot find LinkedIn or website, log as "Research blocked" and skip.`}
  caption="Fill in the brackets with client-specific data. The model reads this at every session start."
/>
...
**Related:** [GTM AI Agent Architecture: the four-layer stack guide](/insights/gtm-ai-agent-four-layer-architecture-guide) · [B2B CRM as a Revenue Operations System: how to rebuild it right](/insights/b2b-crm-revenue-operations-system-guide)
