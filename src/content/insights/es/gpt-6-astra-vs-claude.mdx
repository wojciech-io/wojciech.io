---
title: "GPT-6 Astra quedó cuarto en su propia tabla de lanzamiento. Una semana después, el índice independiente lo puso a la par de Claude Fable 5.1."
seoTitle: "GPT-6 Astra vs Claude Fable 5.1 y Opus 5: puntuación y precio"
description: "Cuarto en la tabla de lanzamiento de OpenAI, GPT-6 Astra empata ahora con Claude Fable 5.1 en el índice v4.3, y probarlo costó un 59% menos."
...
sources:
  ...
  - url: "https://artificialanalysis.ai/articles/artificial-analysis-intelligence-index-v4-3"
    ...
    claim: "Artificial Analysis describe a Astra y Fable 5.1 como empatados en cabeza en v4.3"
    checkedAt: "2026-09-16"
  - url: "https://artificialanalysis.ai/articles/artificial-analysis-intelligence-index-v4-3"
    claim: "Datos del gráfico de v4.3: Fable 5.1 53,37, GPT-6 Astra 52,81, Opus 5 50,70"
    checkedAt: "2026-09-16"
  - url: "https://artificialanalysis.ai/models/gpt-6-astra"
    quote: "$5324.10 to evaluate GPT-6 Astra (max) on the Intelligence Index"
    claim: "Ejecutar el índice con Astra costó 5.324,10 dólares"
    checkedAt: "2026-09-16"
  - url: "https://artificialanalysis.ai/models/claude-fable-5-1"
    quote: "$13128.86 to evaluate Claude Fable 5"
    claim: "Ejecutar el índice con Fable 5.1 costó 13.128,86 dólares"
    checkedAt: "2026-09-16"
  - url: "https://artificialanalysis.ai/models/claude-opus-5"
    ...
    claim: "Ejecutar el índice con Opus 5 costó 7.274,74 dólares"
    checkedAt: "2026-09-16"
  - url: "https://developers.openai.com/api/docs/models/gpt-6-astra"
    ...
    claim: "Regla de precios de GPT-6 Astra para contexto largo"
    checkedAt: "2026-09-16"
  - url: "https://artificialanalysis.ai/agents/coding-agents/comparisons/claude-code-vs-codex"
    ...
    claim: "Coste por tarea en el Coding Agent Index: Codex con Astra 7,47 dólares, Claude Code con Fable 5.1 12,39"
    checkedAt: "2026-09-16"
tldr:
...
<Callout type="note" title="Actualizado el 16 de septiembre de 2026: ya hay cifras independientes">
  Cuando se publicó este texto, las únicas puntuaciones del índice venían de la tabla de lanzamiento de la propia OpenAI, sobre el Intelligence Index v4.1.1, con Astra en cuarto lugar. Desde entonces Artificial Analysis ha probado los modelos por su cuenta en v4.3, y Astra comparte ahora el primer puesto con Claude Fable 5.1. El análisis del lanzamiento sigue abajo tal como estaba, porque recoge lo que OpenAI afirmó ese día. Las cifras actuales van primero.
</Callout>
...
<DataTable
  columns={[
    ...
    { key: "index", label: "Índice v4.3", align: "center", mono: true },
    { key: "run", label: "Coste de ejecutar el índice", align: "center", mono: true },
    { key: "tokens", label: "Tokens generados", align: "center", mono: true },
  ...
  highlight={[1]}
  caption="Artificial Analysis Intelligence Index v4.3 con dos decimales a partir de los datos del gráfico, y coste de ejecución y tokens de las páginas de cada modelo, a 16 de septiembre de 2026. Es una versión del índice posterior a la tabla de lanzamiento de más abajo, así que las dos series de puntuaciones no se pueden comparar directamente."
/>
