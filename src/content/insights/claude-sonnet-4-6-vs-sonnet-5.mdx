...
<DataTable
  ...
  rows={[
    ...
    { row: "Intelligence Index v4.3", old: "25 (non-reasoning)", new: "38 (max effort)" },
...
**Higher on the index**, with a caveat on the comparison. Sonnet 5 at maximum effort scores 38 on Intelligence Index v4.3. The Sonnet 4.6 figure shown is its non-reasoning variant at 25. That is not a like-for-like pair, so I read it as direction rather than distance, and a 13-point gap is wide enough that I would trust the direction.
