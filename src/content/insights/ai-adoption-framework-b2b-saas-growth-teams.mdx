...
<DataTable
  columns={[
    { key: "test", label: "Test" },
    { key: "question", label: "What you are asking" },
  ]}
  rows={[
    { test: "Frequency", question: "How often does this task happen?" },
    { test: "Cost", question: "Time, headcount, or missed speed?" },
    { test: "AI fit", question: "Structure-able, or deep human judgment?" },
  ]}
/>
...
## The first cohort, in a B2B SaaS that runs outbound
