...
<DataTable
  columns={[
    { key: "test", label: "Test" },
    { key: "question", label: "O co pytasz" },
  ]}
  rows={[
    { test: "Częstotliwość", question: "Jak często ten task się zdarza?" },
    { test: "Koszt", question: "Czas, headcount czy utracona szybkość?" },
    { test: "Dopasowanie do AI", question: "Strukturalizowalne czy głęboka ludzka ocena?" },
  ]}
/>
...
## Pierwsza kohorta w B2B SaaS, które robi outbound
