...
<Callout type="note" title="Claude Opus 5.5 zastąpił Opusa 5">
  Anthropic wypuścił Claude Opus 5.5 22 września 2026 po $4 / $20 za milion tokenów wobec $5 / $25 Opusa 5, ściął odczyt cache z $0,50 do $0,20 i przestawił na niego własną domyślną rekomendację. Wszystko poniżej nadal opisuje Opusa 5. Aktualny model opisuje [Opus 5.5 kontra Opus 5](/pl/insights/claude-opus-5-5-vs-claude-opus-5/).
</Callout>
