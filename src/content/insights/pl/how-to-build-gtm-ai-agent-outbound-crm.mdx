...
Wystarczy Claude Code, kilka narzędzi z [MCP](https://modelcontextprotocol.io), dobrze zorganizowany plik CLAUDE.md (pobierz [szablon startowy](/resources/)) oraz pięć połączonych ze sobą umiejętności operatorów.
...
Jeśli tworzysz coś podobnego lub chcesz zobaczyć, jak działa ten pakiet startowy, [umów się na rozmowę](/pl/contact/). Chętnie omówię z Tobą jego architekturę.
