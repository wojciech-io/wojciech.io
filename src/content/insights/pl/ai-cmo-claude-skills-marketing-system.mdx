...
coverType: "system"
# Odkomentuj po wygenerowaniu okładki pod pasującą ścieżką:
...
<Quote author="Komentarz pod oryginalnym postem" source="LinkedIn, sierpień 2026">
...
<Callout type="warning" title="Awaria, której nie zauważysz przez kwartał">
...
<StackLayer
  title="Operator CMO: trzy warstwy, osiem skilli"
  layers={[
