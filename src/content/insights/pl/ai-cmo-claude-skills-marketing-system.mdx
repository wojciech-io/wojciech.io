...
<Diagram caption="Prośba, która nie pasuje do żadnego zakładu, nie jest pisana. Zostaje zapisana jako odmowa, z ceną zmiany planu obok.">
  <Box variant="muted" label="prośba" sub="nie służy żadnemu zakładowi" />
  <Arrow direction="right" dashed label="brak dopasowania" />
