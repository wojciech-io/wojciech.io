---
title: "GTM AI Agent Architecture: the four-layer stack guide"
description: "A detailed breakdown of the GTM AI agent architecture: operator identity, MCP tools, client memory, and reusable skills that make it work in production."
