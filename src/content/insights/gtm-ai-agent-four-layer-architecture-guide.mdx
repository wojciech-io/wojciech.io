...
ogImage: "/images/insights/gtm-ai-agent-four-layer-architecture-guide.webp"
featured: false
draft: false
tldr:
...
The [Claude Code](https://docs.anthropic.com/en/docs/claude-code/overview) GTM Agent Starter Pack has a four-layer architecture. You can grab the base template from [/bites/](/bites/). Each layer has a specific job. Understanding the layers is the difference between running a system and running a chatbot that forgets everything between sessions.
