...
<DataTable
  ...
  rows={[
    ...
    { row: "Intelligence Index v4.3", old: "50", new: "53" },
...
Yes, once the three breaking changes are handled. The index gain is three points at no change in list price, and the capability gains Anthropic lists sit where people use a Fable-class model in the first place: long agentic coding, research, and documents that end up finished.
