...
description: "The website rebuild I ran at Symfonia, an ERP and business software vendor, treated as a revenue system: protect the SEO equity, keep the lead paths, and tie the new site to pipeline instead of redesigning for its own sake."
...
This playbook comes from the replatform I led at [Symfonia](https://symfonia.pl), an ERP and business software vendor, as Head of Growth and Web Development. The site carried years of ranking history and its lead paths fed a CRM the sales team worked every day, so the migration ran with CMS integration and monitoring and went live without disruption. Lead generation finished the year up 30%, on segmented landing pages, CRO tests and CRM routing rather than on the redesign itself.
