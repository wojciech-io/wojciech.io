---
title: "Relora growth architecture: building a connected growth system from scratch"
...
This is the architecture work I did for Relora at that inflection point.
...
The activation problem at Relora was: customers signed up, got a founder check-in call, and either activated or didn't based on that call. No founder call = high churn risk.
