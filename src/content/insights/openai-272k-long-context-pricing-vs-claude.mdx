...
coverImage: "/images/insights/openai-272k-long-context-pricing-vs-claude.webp"
---

<Callout type="note" title="The 272K rule now applies to GPT-6 Sol and Luna too">
  GPT-6 Sol ($2 / $10) and GPT-6 Luna ($0.10 / $0.50) shipped on 22 September 2026 carrying the same rule: above 272K input tokens the whole request is repriced at 2x input and 1.5x output. The arithmetic below is unchanged, only the rates move. For the current models, read [GPT-6 Sol against GPT-6 Astra](/insights/gpt-6-sol-vs-gpt-6-astra/).
</Callout>
