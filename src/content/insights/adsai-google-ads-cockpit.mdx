---
title: "AdsAI: replacing the Google Ads UI with a decision cockpit"
description: "Why I built an AI-native Google Ads cockpit instead of using the native UI — and what the architecture looks like from the inside."
