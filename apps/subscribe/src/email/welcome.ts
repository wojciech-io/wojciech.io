              ...
              <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="padding: 40px 40px 32px;">
                ...
                <tr>
                  <td style="padding-bottom: 16px;">
                    <p style="font-size: 10px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.16em; color: #74746e; margin-bottom: 12px;">Subscription confirmed</p>
                ...
                <tr>
                  <td style="padding-bottom: 32px;">
                    <p class="email-muted" style="font-size: 15px; line-height: 1.65; color: #343430; margin-bottom: 12px;">
                      <strong class="email-text" style="color: #080808; font-weight: 600;">${email}</strong> is now on the AI Espresso list. The next issue lands in this inbox: three stories on AI models, agents, and GTM systems, each with a why it matters, readable in the time it takes to make an espresso.
                    </p>
